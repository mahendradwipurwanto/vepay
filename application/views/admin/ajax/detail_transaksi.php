...
<div class="accordion" id="accordionExample">
  <div class="accordion-item">
    <div class="accordion-header mb-2" id="headingOne">
      <a class="accordion-button bg-primary text-white" role="button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
        	...
        	<li class="list-group-item p-3">
        		<div class="row">
        			...
        			<div class="col-sm-8 mb-2 mb-sm-0">
        				...
        				<img src="<?= base_url();?><?= $transaksi->img_metode;?>" alt="<?= $transaksi->metode;?>"
  ...
  <div class="accordion-item">
    <div class="accordion-header mb-2" id="headingTwo">
      <a class="accordion-button bg-primary text-white collapsed" role="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
        Bukti transfer
      </a>
    </div>
