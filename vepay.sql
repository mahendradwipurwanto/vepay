...
insert  into `tb_auth`(`user_id`,`username`,`email`,`password`,`role`,`status`,`online`,`device`,`log_time`,`created_at`) values 
('1','ngodingin','ngodingin.indonesia@gmail.com','$2y$10$1hg1pDmFo9NYLXLuKxr86.qZpBwWcFo.gQgLLye5Hsk9VXmZqdW12',0,1,1,'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Safari/537.36',1670313106,1668947154),
('2','admin','admin@vepay.id','$2y$10$1hg1pDmFo9NYLXLuKxr86.qZpBwWcFo.gQgLLye5Hsk9VXmZqdW12',1,1,1,'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Safari/537.36',1668990210,1668947154),
('USR-MHNDR-d8eb4','mahendra','mahendradwipurwanto@gmail.com','$2y$10$q1XjBKoVw06w1TRBpU60m.x/imDg9sUvOypLR0eFFAHRyY8wt9o1G',2,1,0,NULL,0,1668961722);
...
CREATE TABLE `tb_payments` (
  ...
  `status` int(5) NOT NULL DEFAULT 1 COMMENT '1: pending; 2: success; 3: terminated/reject; 4: cancel; 5: expired',
...
insert  into `tb_product`(`id`,`m_categories_id`,`name`,`price`,`image`,`description`,`created_at`,`created_by`,`modified_at`,`modified_by`,`is_deleted`) values 
(1,0,'Payeer',15999,'assets/images/placeholder.jpg','Test',1669000361,'2',1669002422,'2',0),
(3,1,'Paypal',159999,'berkas/product/11/2022/1669002681.jpg','test',1669002681,'2',1669005938,'2',0),
(4,0,'Paypal',159999,NULL,'test',1669003300,'2',1669003308,'2',1);
...
insert  into `tb_promo`(`id`,`kode`,`nama`,`value`,`expired`,`quota`,`jenis`,`status`,`created_at`,`created_by`,`modified_at`,`modified_by`,`is_deleted`) values 
(3,'NL051','PROMO NATAL',25000,0,5,1,1,1670291436,'1',1670291819,'1',1),
(4,'NL051','PROMO NATAL',25000,1670432400,5,0,1,1670291682,'1',1670291890,'1',0);
